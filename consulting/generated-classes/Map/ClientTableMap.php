...
class ClientTableMap extends TableMap
{
     ...
     */
    const COL_LASTNAME = 'client.lastname';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Lastname', ),
        self::TYPE_CAMELNAME     => array('id', 'lastname', ),
        self::TYPE_COLNAME       => array(ClientTableMap::COL_ID, ClientTableMap::COL_LASTNAME, ),
        self::TYPE_FIELDNAME     => array('id', 'lastname', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Lastname' => 1, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'lastname' => 1, ),
        self::TYPE_COLNAME       => array(ClientTableMap::COL_ID => 0, ClientTableMap::COL_LASTNAME => 1, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'lastname' => 1, ),
        self::TYPE_NUM           => array(0, 1, )
    );
  ...
  array (
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(ClientTableMap::COL_LASTNAME);
        } else {
